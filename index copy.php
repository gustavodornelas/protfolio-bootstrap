            ...
            <div class="carousel-item active" style="background-image: url(assets/imagens/backkground-slide-1.jpg); background-position: center;">
                <div class="carousel-container">
                    <div class="container">
                        ...
                        <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto"><i class="bi bi-whatsapp"></i> &nbsp Agendar</a>
                    </div>
                </div>
            </div>
                ...
                <div class="carousel-container">
                    ...
                    <h2 class="animate__animated animate__fadeInDown text-light mb-5">Sobre mim</h2>
                        <p class="animate__animated animate__fadeInUp">Oi, meu nome é Gustavo Dornelas, tenho 28 anos e moro em Patrocínio/MG. 
                            ...
                            registrando os momentos mais emocionantes e marcantes de qualquer pessoa. 
                            Sinto-me privilegiado por poder compartilhar fases tão especiais e fidedignas, ao captar um choro, um sorriso, um olhar ou mesmo a dor, sentimentos reais que ultrapassam os limites de uma lente.</p>
...
<div class="container">
    <div class="row mt-4 mb-4">
        <div class="col-md-4 text-center mt-2">
            <img src="./assets/imagens/fotos/foto-1.png" alt="" class="rounded-circle img-fluid img-thumbnail">
        </div>
        <div class="col-md-4 text-center mt-2">
            <img src="./assets/imagens/fotos/foto-2.png" alt="" class="rounded-circle text-center img-fluid">
        </div>
        <div class="col-md-4 text-center mt-2">
            <img src="./assets/imagens/fotos/foto-3.png" alt="" class="rounded-circle text-center img-fluid">
        </div>
    </div>
</div>
